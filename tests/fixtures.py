...
menu_schema = Schema(
    tables=[
        Table(name='menu_items', columns=[
            ...
            Column(name='item', data_type='string'), 
            Column(name='solo_price', data_type='float'), 
            Column(name='meal_price', data_type='float')
            ]
            )
        ]
)
...
menu_data = {'tables': [
    {'name': 'menu_items', 'columns': [
        ...
        {'category': 'BREAKFAST', 'item': 'SAUSAGE MCMUFFIN® WITH EGG', 'solo_price': None, 'meal_price': 4.19}, 
        ...
        {'category': 'BURGERS', 'item': 'QUARTER POUNDER® WITH CHEESE DELUXE', 'solo_price': 4.79, 'meal_price': 6.69}, 
